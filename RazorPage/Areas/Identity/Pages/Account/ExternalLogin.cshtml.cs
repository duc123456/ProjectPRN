...
namespace RazorPage.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        {        
            ...
            {
                // co tai khoan nhung chua lien ket dich vu ngoai
                // chua co tk tao dịch du liên ket voi dich vu ngoai
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                AppUser extetnalEmailUser = null;
                //Claim
                ...
                if (externalEmail != null) {
                    extetnalEmailUser = await _userManager.FindByEmailAsync(externalEmail);
                }

                if((extetnalEmailUser != null) && registerUser != null) {

                    //Liên kết tk
                    if (registerUser.Id == extetnalEmailUser.Id)
                    {
