...
namespace RazorPage.Areas.Admin.Pages.ProductImages
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(MyBlogContext context, IWebHostEnvironment environment)
        {
            _context = context;
        ...
        public IActionResult OnPostChangeImageDefault(int id, int pid)
        {
            ...
            var productFromDb = _context.Products.FirstOrDefault(x => x.ProductId == pid);
            if (productFromDb != null)
            {
                productFromDb.ImageDefault = item.Image;
            }
